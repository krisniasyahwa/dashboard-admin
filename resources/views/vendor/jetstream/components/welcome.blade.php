<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Welcome to Ko+Lab Dashboard!
    </div>

    <div class="mt-6 text-gray-500">
        Ko+Lab adalah Kolaborasi Startup Industri Bisnis UMKM Laboratorium yang berada di Fakultas Ilmu Terapan Telkom University.
        <br />Ko+Lab resmi dibentuk pada tanggal 1 Desember 2021.
        <br />
        <br />Mari kita kuat kan VOKASI.
        <br />Dengan memberikan IMPACT pada INDUSTRI, UMKM dan MASYARAKAT
    </div>
</div>
